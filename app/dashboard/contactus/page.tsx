...
function ContactUs() {
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        ...
        >
          ...
          <p className="text-center text-base md:text-lg font-normal max-w-md mt-2 mx-auto ">
            ❤️ Hey Everyone! We are here to help you. If you have any questions or need help, feel free to contact us.❤️ 
          </p>
        </motion.div>
    ...
    <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4 mx">
